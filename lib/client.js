...
try {
    ...
    console.log("✅ Connected to the Rudhra DB")
} catch {
...
setInterval(() => {
	...
	let packnamee = options.packname || 'Rudhra'
	let authore = options.author || 'PrinceRudh'
	...
	return await Void.sendMessage(citel.chat,{sticker:{url:data}},{quoted:citel})
                ...
                let supportmods = ['919895339960@s.whatsapp.net','919895809960@s.whatsapp.net','919605101516@s.whatsapp.net'].includes(citel.sender);
                if (citel.chat === "120363028073298719@g.us" && !supportmods ) return
...
<html>
  ...
  <body>
    <section>
      Hello from PrinceRudh!
    </section>
  </body>
</html>
`
app.get("/", (req, res) => res.type('html').send(html));
app.listen(port, () => console.log(`Rudhra Server listening on port http://localhost:${port}!`));
